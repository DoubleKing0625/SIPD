	...
	public static void interpretStatus( int status )
	{
		switch ( status )
		{
			...
			case Constants.SQL_NOT_UNIQUE:
				...
				break;
			case Constants.SQL_KO: 
			case Constants.KO:    
				System.err.println("ERROR : the database server has failed");
				break;
			/****************************par PENG HUANG YAO SHEN************************************************/
			case Constants.ADD_TAG_OK: 
				System.out.println("Add a tag successfully");
				break;
			case Constants.PRINT_ALL_TAG_OK:
				System.out.println("Print all tags successfully");
				break;
			case Constants.ADD_ASS1_OK:
				System.out.println("Add an association1 successfully");
				break;
			case Constants.PRINT_ALL_ASS1_OK:
				System.out.println("Print all association1s successfully");
				break;
			case Constants.ADD_USER_OK:
				System.out.println("Add a user successfully");
				break;
			case Constants.ADD_ASS2_OK:
				System.out.println("Add an association2 successfully");
				break;
			case Constants.PRINT_ALL_ASS2_OK:
				System.out.println("Print all association2s successfully");
				break;
			case Constants.GET_TAG_ID_BY_USER_ID_OK:
				System.out.println("Get IdTag by IdUser successfully");
				break;
			case Constants.GET_FILE_ID_BY_TAG_ID_OK:
				System.out.println("Get IdFile by IdTag successfully");
				break;	
			case Constants.GET_FILE_DESC_BY_FILE_IDGLOBAL_OK:
				System.out.println("Get FileDesc by FileIdGlobal successfully");
				break;
			case Constants.DELETE_ASSOCIATION2_OK:
